    ...
    <div className="w-full border border-gray-300 flex flex-col">
      ...
      {data.map((t, index) => (
        <div className="w-full" style={{ display: "flex", fontSize: 12 }}>
          ...
          <div className="flex-1 border border-gray-100 p-3">{t.foodName}</div>
          <div className="flex-1 border border-gray-100 p-3">{t.category}</div>
          <div className="flex-1 border border-gray-100 p-3">Open Recipe</div>
          <div className="flex-1 border border-gray-100 flex">
            <div className=" p-3">{t.price}</div>
